...
$query=mysqli_query($koneksi,"SELECT r.id, r.pangkat_awal, r.menjadi_pangkat, r.menjadi_golongan, r.menjadi_ruang, r.tmt_pangkat, p.nama, p.nip, j.nama_pangkat, j.golongan, j.ruang FROM prb_pangkat r
