...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Kecamatan Gunung Timang - <?php require('get_title.php'); ?></title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>Gunung Timang</b></a>
        ...
        <section class="sidebar">
          ...
          <?php else: ?>
            ...
            <li class="<?php if(isset($_GET['page']) && $_GET['page']=="admin") { echo "active"; };
             ...
             ?>">
            <a href="./?page=admin"><i class="fa fa-user text-warning" <?php  if ($_SESSION['username'] !="admin"){ echo "hidden";}; ?>></i> Managemen User</a></li>
            <?php } ?>
            <li class="treeview">
              <a href="logout.php">
